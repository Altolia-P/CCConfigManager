...
class Scanner:
    ...
    def _add_item(self, items: dict, key: tuple[str, str], item: Item, primary: bool) -> None:
        if key in items:
            existing = items[key]
            if primary:
    ...
    def _scan_skill_dir(self, rel_dir: str, status: str, items: dict, primary: bool) -> None:
        ...
        for entry in sorted(base.iterdir()):
            ...
            self._add_item(items, ("skill", entry.name), item, primary)
    ...
    def _scan_file_dir(self, rel_dir: str, item_type: str, status: str, items: dict, primary: bool) -> None:
        ...
        for entry in sorted(base.iterdir()):
            ...
            self._add_item(items, (item_type, name), item, primary)
    ...
    def _scan_rules_dir(self, rel_dir: str, status: str, items: dict, primary: bool) -> None:
        ...
        for root, dirs, files in os.walk(base):
            ...
            for fname in sorted(files):
                ...
                self._add_item(items, ("rule", name), item, primary)
    ...
    def _scan_mcp(self, items: dict) -> None:
        ...
        for name, cfg in data.get("mcpServers", {}).items():
            ...
            self._add_item(items, ("mcp", name), item, primary=True)
    ...
    def _scan_workflows(self, items: dict) -> None:
        ...
        for entry in sorted(wf_dir.iterdir()):
            ...
            self._add_item(items, ("workflow", name), item, primary=True)
    ...
    def _scan_tools(self, items: dict) -> None:
        ...
        for server_name, tools in cache.items():
            for tool in tools:
                ...
                self._add_item(items, ("tool", name), item, primary=True)
